...
**Paper formatting:** Papers are limited to eight pages, including figures and tables, in the CVPR 2026 style. Additional pages containing only cited references are allowed. Please download the [CVPR 2026 Submission Template](https://github.com/cvpr-org/author-kit/archive/refs/tags/CVPR2026-v1(latex).zip) for detailed formatting instructions.
...
**Submission and review process:** Review process is double-blind. We will be using OpenReview to manage submissions. Similar to the review process for [CVPR 2026 conference](http://cvpr.thecvf.com/Conferences/2026), submissions under review will be visible only to their assigned members of the program committee. The reviews and author responses will never be made public, and we will not be soliciting comments from the general public during the reviewing process. 
...
OpenReview author instructions can be found [here](https://cvpr.thecvf.com/Conferences/2026/CompleteYourORProfile).
...
## Important Dates 
- Submission deadline (**extended**): March 10, 2026 (23:59 AoE)
- Paper notification: March 24, 2026
