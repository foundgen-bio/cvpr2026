...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/cvpr2026/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/cvpr2026/call_for_paper/";
          },
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-submission-deadline-is-extended-to-march-7",
          title: 'Submission deadline is extended to March 7!',
          description: "",
          section: "News",},{
      id: 'light-theme',
